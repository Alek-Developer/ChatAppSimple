...
// Definiranje so varijabli na user.
    private var userName : String? = null
    private var userPhotoUrl : String? = null

// Definiranje so varijabli na FirebaseUser i FirebaseAuth.
    private  var fireBaseAuth : FirebaseAuth? = null
    private  var firebaseUser : FirebaseUser? = null

// Google Api Client e objekt za pristap do Google Api kako biblioteka za servise na Google Play - kako sto e Google Sign in isl.
...
// Tuka gi inicijalizirame UserName, firebaseAuth, farebaseUser isl servisi na Google.
        userName = ANONYMOUS

        fireBaseAuth = FirebaseAuth.getInstance()
        firebaseUser = fireBaseAuth!!.currentUser

// Proverka za toa dali e user-ot (conektiran ili ne) od 93 do 105 linija.
    ...
    class MessageViewHolder(v : View) : RecyclerView.ViewHolder(v){
        ...
        fun bind(message : Message){
            ...
            if (message.photoUrl == null){
                userImage.setImageDrawable(ContextCompat.getDrawable(userImage.context, R.drawable.default_user_blue))
            }else{
